...
public class PageBase {
    ...
    public void selectByValueFromTheDropdown(WebElement element, String valueToBeSelected) {
    	Select select = new Select(element);
        select.selectByValue(valueToBeSelected);   
    }
    
    public void selectByVisibleTextFromTheDropdown(WebElement element, String valueToBeSelected) {
    	Select select = new Select(element);
